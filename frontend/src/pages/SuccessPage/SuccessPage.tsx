...
const SuccessPage: React.FC = () => {
    return (
        <div className="bg-background text-on-background font-body-md antialiased selection:bg-secondary/20 selection:text-primary min-h-screen">
            {/* HERO */}
            <section className="relative w-full min-h-[45vh] flex flex-col items-center justify-center overflow-hidden pt-24">
                {/* Background */}
                ...
                <div className="relative z-10 flex flex-col items-center text-center px-5 md:px-16 max-w-4xl mx-auto">
                    <div className="mb-8 p-4 rounded-full bg-white/50 backdrop-blur-sm border border-secondary/20 shadow-xl">
            <span
            ...
            >
              check_circle
                    ...
                    {/* Booking Status */}
                    <div className="flex flex-col sm:flex-row items-center gap-6 bg-white border border-outline-variant/30 rounded-full px-8 py-4 shadow-sm">
                    ...
                    <span className="text-xs uppercase tracking-[0.2em] text-on-surface-variant">
                      ...
                      5.650.000 ₫
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 items-center">
                            <button className="w-full sm:w-auto px-8 py-4 bg-primary text-white uppercase tracking-[0.2em] text-sm flex items-center justify-center gap-2 hover:opacity-90 transition rounded-lg">
                <span className="material-symbols-outlined text-[18px]">
                  download
                </span>
                                Tải PDF
                            ...
                            <button className="w-full sm:w-auto px-8 py-4 border border-outline text-primary uppercase tracking-[0.2em] text-sm flex items-center justify-center gap-2 hover:bg-gray-50 transition rounded-lg">
                <span className="material-symbols-outlined text-[18px]">
                  calendar_add_on
                </span>
                                Thêm lịch
              ...
              <span className="material-symbols-outlined text-[48px] text-secondary mb-4">
                ...
                <span className="text-xs uppercase tracking-[0.2em] text-white/80 mb-2 block">
                  KHÁM PHÁ
                        ...
                        {/* Spa */}
                        <div className="group relative h-[300px] overflow-hidden rounded-xl border border-outline-variant/20 cursor-pointer">
                            <div
                                className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
                                style={{
                                    backgroundImage:
                ...
                <span className="material-symbols-outlined text-[32px] text-white mb-4">
                  spa
                                ...
                                <button className="px-6 py-3 border border-white text-white uppercase tracking-[0.2em] text-sm hover:bg-white hover:text-black transition rounded-lg">
                                    Đặt Ngay
                                </button>
                            </div>
                        </div>
